    ...
    return(
      <div className="form-container">
        ...
        <h3>Amount:</h3>
          ...
          <select id="baseCurrency" value={baseCurrency} onChange={this.changeBaseCurrency}>
            {currencyChoice}
       ...
       <h2 id='result-text'>{baseAmount} {baseCurrency} = {result} {convertToCurrency}</h2>
     </div>
    );
  }
}
